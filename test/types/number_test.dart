  ...
  group('$AcanthisNumber', () {
    ...
    test(
      ...
      () {
        ...
        final expected = {'type': 'number', 'minimum': 1, 'maximum': 3};
        ...
        final expected4 = {'type': 'number', 'minimum': 10, 'maximum': 30};
    ...
    test(
      ...
      () {
        ...
        final expected = {'type': 'number', 'multipleOf': 2};
        expect(result, expected);
      },
    );
